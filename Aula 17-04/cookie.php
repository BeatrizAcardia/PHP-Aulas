...
if (!isset($_COOKIE['InfoUser-Nome'])){
    $msg = "Voce não é cadastrado em nosso site! Para ter acesso ao conteudo exclusivo do assinante, <a href='cadastra.php'>clique aqui!</a>";
} else{
    ...
    if ($idade < 18) {
        $msg = "<span style 'color: red';>Você não tem idade para este site!</span>";
    } else {
